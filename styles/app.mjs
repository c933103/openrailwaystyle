import { SPEED_BANDS, UNKNOWN_COLOR, INFRASTRUCTURE, DEM_URL, CONTOUR_OPTIONS, SEARCH_API, LANGUAGES, labelExpression, displayName, ORM, MODES, readSettings, formatSpeed, numericSpeed, stationRank, decodeLifecycleTile } from './map-model.mjs?v=20260926-6';

import {installLabelProtocols, localizeTile, locate} from './vendor/tile-labels.js?v=20260926-6';
...
const assetVersion = new URL(import.meta.url).searchParams.get('v') || '20260926-6';
